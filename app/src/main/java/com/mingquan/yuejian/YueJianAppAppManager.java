 ...
 *
 */
public class YueJianAppAppManager {
  private static Stack<Activity> activityStack;
  private static YueJianAppAppManager instance;

  private YueJianAppAppManager() {}

  /**
   * 单一实例
   */
  public static YueJianAppAppManager getAppManager() {
    if (instance == null) {
      instance = new YueJianAppAppManager();
    }
    return instance;
  }

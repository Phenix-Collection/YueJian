 ...
 */
public final class YueJianAppHMSAgentLog {
    ...
    public static void d(String log) {
        ...
        if (logCallback != null) {
            logCallback.logD("YueJianAppHMSAgent", sb.toString());
        } else {
            Log.d("YueJianAppHMSAgent", sb.toString());
        }
    }
    ...
    public static void v(String log) {
        ...
        sb.append(log);
        if (logCallback != null) {
            logCallback.logV("YueJianAppHMSAgent", sb.toString());
        } else {
            Log.v("YueJianAppHMSAgent", sb.toString());
        }
    }
    ...
    public static void i(String log) {
        ...
        sb.append(log);
        if (logCallback != null) {
            logCallback.logI("YueJianAppHMSAgent", sb.toString());
        } else {
            Log.i("YueJianAppHMSAgent", sb.toString());
        }
    }
    ...
    public static void w(String log) {
        ...
        sb.append(log);
        if (logCallback != null) {
            logCallback.logW("YueJianAppHMSAgent", sb.toString());
        } else {
            Log.w("YueJianAppHMSAgent", sb.toString());
        }
    }
    ...
    public static void e(String log) {
        ...
        if (logCallback != null) {
            logCallback.logE("YueJianAppHMSAgent", sb.toString());
        } else {
            Log.e("YueJianAppHMSAgent", sb.toString());
        }
    }

 ...
 */
public abstract class YueJianAppBaseFullModeActivity extends YueJianAppFullScreenModeActivity implements YueJianAppIDialogControl, View.OnClickListener, YueJianAppIBaseView {
...
//    init(this);
        ...
        if (ConnectivityManager.CONNECTIVITY_ACTION.equals(action)) {
          ...
          if (mNetWorkInfo != null && mNetWorkInfo.isAvailable()) {
            ...
            if (mNetWorkInfo.getType() == ConnectivityManager.TYPE_WIFI) {
              YueJianAppSharedPreUtil.put(YueJianAppBaseFullModeActivity.this, YueJianAppAppConfig.HAS_ALERT_NETWORK_CHANGE, false);
              /////WiFi网络
              ...
              if (null != mToastDialog) {
                if (!YueJianAppSharedPreUtil.getBoolean(
                        YueJianAppBaseFullModeActivity.this, YueJianAppAppConfig.HAS_ALERT_NETWORK_CHANGE, false)) {
                  mToastDialog.setTitle(getString(R.string.net_work_change));
                  mToastDialog.setTimeLong(10 * 1000);
                  mToastDialog.show();
                  YueJianAppSharedPreUtil.put(YueJianAppBaseFullModeActivity.this, YueJianAppAppConfig.HAS_ALERT_NETWORK_CHANGE, true);
                }
              }
            }
          } else {
  ...
  public Dialog onCreateDialog(int id) {
    ...
    switch (id) {
      case YueJianAppAppConfig.DIALOG_PROGRESS:
        if (mProgressDialog == null) {
          YueJianAppTLog.error("Dialog方法调用错误,请调用showProgressDialog()!");
        }
  ...
  protected void initActionBar(ActionBar actionBar) {
    ...
    mActionBarView.findViewById(R.id.base_title)
  ...
  public ProgressDialog showWaitDialog(String message) {
    if (_isVisible) {
      if (_waitDialog == null) {
        _waitDialog = YueJianAppDialogHelp.getWaitDialog(/*getLayoutInflater(),*/ this, message);

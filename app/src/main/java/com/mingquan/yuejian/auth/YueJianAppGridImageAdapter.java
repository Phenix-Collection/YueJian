...
public class YueJianAppGridImageAdapter extends RecyclerView.Adapter<YueJianAppGridImageAdapter.ViewHolder> {
    ...
    public YueJianAppGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {

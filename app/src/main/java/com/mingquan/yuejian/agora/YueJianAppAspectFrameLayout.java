 ...
 */
public class YueJianAppAspectFrameLayout extends FrameLayout {
    private static final String TAG = "AFL";

    private double mTargetAspect = -1.0;        // initially use default window size

    public YueJianAppAspectFrameLayout(Context context) {
        super(context);
    }

    public YueJianAppAspectFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

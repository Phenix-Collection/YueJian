 ...
 */
public class YueJianAppFURenderer {
    private static final String TAG = YueJianAppFURenderer.class.getSimpleName();
     ...
     * FURenderer构造函数
     */
    private YueJianAppFURenderer(Context context, boolean isCreateEGLContext) {
...
//          faceunity.fuItemSetParam(mItemsArray[ITEM_ARRAYS_FACE_BEAUTY_INDEX], "blur_blend_ratio", 1);
    ...
    public static class Builder {
        ...
        public YueJianAppFURenderer build() {
            YueJianAppFURenderer fuRenderer = new YueJianAppFURenderer(context, createEGLContext);

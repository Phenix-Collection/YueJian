...
public class YueJianAppCameraRenderer implements Camera.PreviewCallback, GLSurfaceView.Renderer {
    public final static String TAG = YueJianAppCameraRenderer.class.getSimpleName();
    ...
    public YueJianAppCameraRenderer(Activity activity, GLSurfaceView GLSurfaceView, OnRendererStatusListener onCameraRendererStatusListener) {
        mActivity = activity;

...
public class YueJianAppEffectAndFilterSelectAdapter extends RecyclerView.Adapter<YueJianAppEffectAndFilterSelectAdapter.ItemViewHolder> {
    ...
    public static final String[] EFFECT_ITEM_FILE_NAME = {"none", "vip_filter.bundle", "item0204.bundle", "bg_seg.bundle", "fu_zh_duzui.bundle",
    ...
    private YueJianAppEffectAndFilterItemView lastClickItemView = null;
    ...
    public YueJianAppEffectAndFilterSelectAdapter(RecyclerView recyclerView, int recyclerViewType) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(new YueJianAppEffectAndFilterItemView(parent.getContext()));
    }

    class ItemViewHolder extends RecyclerView.ViewHolder {
        YueJianAppEffectAndFilterItemView mItemView;

        public ItemViewHolder(View itemView) {
            super(itemView);
            mItemView = (YueJianAppEffectAndFilterItemView) itemView;
        }
    }
